...
def main():
    ...
    filename = "results/Bacteria_ID/thirty/results_mlrod.txt"
    print(device)
    ...
    for batch_size in batch_sizes:
        for lr in lrs:
            ...
            #Pretraining
            model = MLROD_model(sp_size=1000,num_classes=30).to(device)
            ...
            for epoch in range(epochs):
                ...
                if acc>best_acc:
                  #Deleting the previous best model
                    ...
                    best_acc = acc
                    best_model_name = f"results/Bacteria_ID/models/model_mlrod_{epoch}_{round(acc,2)}_.pt"
            ...
            pretrained_model = MLROD_model(sp_size=1000,num_classes=30).to(device)
            ...
            for epoch in range(epochs):
                ...
                if acc>best_val_acc:
                    ...
                    if best_val_acc>all_best_val_acc:
                        ...
                        #Saving the current model
                        best_final_model_name = f"results/trained_models/Bacteria_thirty_mlrod_{epoch}_{round(acc,2)}_.pt"
