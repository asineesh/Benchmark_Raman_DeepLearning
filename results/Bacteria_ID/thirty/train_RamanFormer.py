...
def main():
    ...
    filename = "results/Bacteria_ID/thirty/results_RamanFormer.txt"
    print(device)
            ...
            for epoch in range(epochs):
                ...
                if acc>best_val_acc:
                    ...
                    if best_val_acc>all_best_val_acc:
                        ...
                        #Saving the current model
                        best_final_model_name = f"results/trained_models/Bacteria_thirty_RamanFormer_{epoch}_{round(acc,2)}_.pt"
