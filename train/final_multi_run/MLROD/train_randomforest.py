...
def main():
    ...
    filename = "results/final_multi_run/MLROD/results_RandomForest.txt"
    ...
    for run in range(args.runs):
        ...
        best_final_model_name = f"results/final_multi_run/trained_models/MLROD_RandomForest_{run}_{round(accuracy,2)}_.pkl"
