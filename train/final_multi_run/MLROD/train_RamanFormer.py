...
def main():
    ...
    filename = "results/final_multi_run/MLROD/results_RamanFormer.txt"
    ...
    for run in range(args.runs):
        ...
        for epoch in range(epochs):
            ...
            if acc>best_val_acc:
                ...
                best_final_model_name = f"results/final_multi_run/trained_models/MLROD_RamanFormer_{run}_{epoch}_{round(acc,2)}_.pt"
