...
def main():
    ...
    filename = "results/final_multi_run/Pharma/results_RamanFormer.txt"
    ...
    for run in range(args.runs):
        ...
        model = RamanFormer(num_classes=32).to(device)
        ...
        for epoch in range(epochs):
            ...
            if acc>best_val_acc:
                ...
                best_final_model_name = f"results/final_multi_run/trained_models/Pharma_RamanFormer_{run}_{epoch}_{round(acc,2)}_.pt"
