...
def main():
    ...
    filename = "results/final_multi_run/Bacteria_ID/eight/results_RamanNet.txt"
    ...
    for run in range(args.runs):
        ...
        for epoch in range(epochs):
            ...
            if acc>best_val_acc:
                ...
                best_final_model_name = f"results/final_multi_run/trained_models/Bacteria_ID_eight_RamanNet_pre_{run}_{epoch}_{round(acc,2)}_.pt"
        ...
        for epoch in range(epochs):
            ...
            if acc>best_val_acc:
                ...
                #Saving the current model
                best_final_model_name = f"results/final_multi_run/trained_models/Bacteria_ID_eight_RamanNet_fine_{run}_{epoch}_{round(acc,2)}_.pt"
