...
def main():
    ...
    parser.add_argument("--n_estimator", type=int,help="The number of estimators",default=300)
    ...
    filename = "results/final_multi_run/Bacteria_ID/eight/results_RandomForest.txt"
    ...
    for run in range(args.runs):
        ...
        best_final_model_name = f"results/final_multi_run/trained_models/Bacteria_ID_eight_RandomForest_{run}_{round(accuracy,2)}_.pkl"
