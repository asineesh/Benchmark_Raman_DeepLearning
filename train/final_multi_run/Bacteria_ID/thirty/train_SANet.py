...
def main():
    ...
    filename = "results/final_multi_run/Bacteria_ID/thirty/results_SANet.txt"
    ...
    for run in range(args.runs):
        ...
        #Pretraining
        model = ScaleAdaptiveNet(num_classes=30).to(device)
        ...
        for epoch in range(epochs):
            ...
            if acc>best_val_acc:
                ...
                best_final_model_name = f"results/final_multi_run/trained_models/Bacteria_ID_thirty_SANet_pre_{run}_{epoch}_{round(acc,2)}_.pt"
        ...
        pretrained_model = ScaleAdaptiveNet(num_classes=30).to(device)
        ...
        for epoch in range(epochs):
            ...
            if acc>best_val_acc:
                ...
                #Saving the current model
                best_final_model_name = f"results/final_multi_run/trained_models/Bacteria_ID_thirty_SANet_fine_{run}_{epoch}_{round(acc,2)}_.pt"
