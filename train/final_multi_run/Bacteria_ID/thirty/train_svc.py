...
def main():
    ...
    filename = "results/final_multi_run/Bacteria_ID/thirty/results_SVC.txt"
    ...
    for run in range(args.runs):
        ...
        best_final_model_name = f"results/final_multi_run/trained_models/Bacteria_ID_thirty_SVC_{run}_{round(accuracy,2)}_.pkl"
