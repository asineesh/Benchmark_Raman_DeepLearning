...
def main():
    filename = "results/hyperparameter_tuning/Bacteria_ID/eight/results_RandomForest.txt"
        ...
        for n_estimator in n_estimators:
            for max_depth in max_depths:
                ...
                if accuracy>best_accuracy:
                    ...
                    best_final_model_name = f"results/hyperparameter_tuning/trained_models/Bacteria_eight_RandomForest_{round(accuracy,2)}_.pkl"
