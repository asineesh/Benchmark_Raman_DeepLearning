...
def main():
    filename = "results/hyperparameter_tuning/Bacteria_ID/eight/results_SVC.txt"
    ...
    ref_set = Bacteria_Dataset("datasets/Bacteria_ID/X_reference.npy","datasets/Bacteria_ID/y_reference.npy",8)
    ...
    for combination in combinations:
        ...
        for C in Cs:
            for kernel in kernels:
                iteration = f"For Combination {combination}, C {C} and kernel {kernel}"
                ...
                if accuracy>best_accuracy:
                    ...
                    best_final_model_name = f"results/hyperparameter_tuning/trained_models/Bacteria_eight_SVC_{round(accuracy,2)}_.pkl"
