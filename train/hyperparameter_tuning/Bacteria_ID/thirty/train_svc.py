...
def main():
    filename = "results/hyperparameter_tuning/Bacteria_ID/thirty/results_SVC.txt"
        ...
        for C in Cs:
            for kernel in kernels:
                ...
                if accuracy>best_accuracy:
                    ...
                    best_final_model_name = f"results/hyperparameter_tuning/trained_models/Bacteria_thirty_SVC_{round(accuracy,2)}_.pkl"
