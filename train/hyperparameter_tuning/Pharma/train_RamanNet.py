...
def main():
    ...
    filename = "results/hyperparameter_tuning/Pharma/results_RamanNet.txt"
    print(device)
    ...
    for batch_size in batch_sizes:
        for lr in lrs:
            ...
            model = RamanNet(num_classes=32).to(device)
            ...
            for epoch in range(epochs):
                ...
                if acc>best_val_acc:
                    ...
                    if best_val_acc>all_best_val_acc:
                        ...
                        best_final_model_name = f"results/hyperparameter_tuning/trained_models/Pharma_RamanNet_{epoch}_{round(acc,2)}_.pt"
