...
def main():
    filename = "results/hyperparameter_tuning/Pharma/results_RandomForest.txt"
    ...
    for n_estimator in n_estimators:
        for max_depth in max_depths:
            iteration = f"For Number of estimators {n_estimator} and Max depth {max_depth}"
            ...
            if accuracy>best_accuracy:
                ...
                best_final_model_name = f"results/hyperparameter_tuning/trained_models/Pharma_RandomForest_{round(accuracy,2)}_.pkl"
